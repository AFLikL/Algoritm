    ...
    class Carasuba
    {
        ...
        static long karasuba(long xIn, long yIn)
        {
            ...
            if (n % 2 == 0)
            {
                ...
                a = x / Convert.ToInt32(Math.Pow(10, n / 2)); b = x % Convert.ToInt32(Math.Pow(10, n / 2));
                c = y / Convert.ToInt32(Math.Pow(10, n / 2)); d = y % Convert.ToInt32(Math.Pow(10, n / 2));
                long s1, s2, s3, s4, s5; s1 = a * c;
                s2 = b * d; s3 = (a + b) * (c + d);
                s4 = s3 - s1 - s2; s5 = s1 * Convert.ToInt32(Math.Pow(10, n)) + s4 * Convert.ToInt32(Math.Pow(10, n / 2)) + s2;
            ...
            else
            {
                ...
                long s1, s2, s3, s4, s5; s1 = a * c;
                s2 = b * d; s3 = (a + b) * (c + d);
                s4 = s3 - s1 - s2; s5 = s1 * Convert.ToInt32(Math.Pow(10, n - 1)) + s4 * Convert.ToInt32(Math.Pow(10, n / 2)) + s2;
                // Console.WriteLine(s5);                 //lastcara = s5;
